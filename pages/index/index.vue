...
<!-- 			<view class="swiper-section">
			...
			<view class="quick-entrance">
				<view class="quick-grid">
					<view class="quick-item" v-for="item in quickList" :key="item.id" @click="handleQuickClick(item)">
...
<!-- 				<view class="func-card" @click="goToDynamic">
			...
			<!-- <view class="dynamic-section">
				...
				<view class="dynamic-list">
					<view class="dynamic-card" v-for="item in dynamicList" :key="item.id"
...
<!-- 			<view class="contact-section">
				<view class="custom-card">
					<view class="card-body contact-content">
						...
						<button class="contact-btn primary-outline-btn" type="default" size="mini" @click="contactUs">
							在线咨询
						</button>
					</view>
				</view>
			...
			<view class="contact-section">
				<view class="custom-card">
					<text class="contact-info">{{hitokoto}} --- {{anthor}}</text>
				</view>
			</view>
		</scroll-view>
		...
		<view class="bottom-action">
			<button class="action-btn primary-btn gradient-primary" @click="goToRecruitment">
...
<script setup>
	...
	const getYuYan = async () => {
		try {
			const res = await instance.appContext.config.globalProperties.$http.get(
				'https://whyta.cn/api/tx/lzmy?key=738b541a5f7a')
			if (res.code === 200) {
